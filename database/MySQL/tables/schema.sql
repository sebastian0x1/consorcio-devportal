CREATE TABLE tag_accounts (
  tag_account_id INT(11) NOT NULL AUTO_INCREMENT,
  tag_account VARCHAR(255) NOT NULL,
  tag_account_name VARCHAR(50) NOT NULL,
  tag_account_color VARCHAR(10) NOT NULL DEFAULT 'orange',
  ...
  UNIQUE KEY `tag_accounts_unique` (tag_account_name)
);

CREATE TABLE stages (
  stage_id INT(11) NOT NULL AUTO_INCREMENT,
  stage_name VARCHAR(50) NOT NULL,
  stage_color VARCHAR(10) NOT NULL DEFAULT 'orange',
...
CREATE TABLE apis (
  ...
  api_color VARCHAR(10) NOT NULL DEFAULT 'orange',
...
CREATE TABLE permissions (
  ...
  permission_color VARCHAR(10) NOT NULL DEFAULT 'orange',
...
CREATE TABLE business_lines (
  ...
  business_line_color VARCHAR(10) NOT NULL DEFAULT 'orange',
...
CREATE TABLE roles (
  ...
  role_color VARCHAR(10) NOT NULL DEFAULT 'orange',
...
CREATE TABLE apis_tag_accounts (
...
CREATE TABLE business_lines_apis (
...
CREATE TABLE business_lines_tag_accounts (
...
CREATE TABLE roles_business_lines (
